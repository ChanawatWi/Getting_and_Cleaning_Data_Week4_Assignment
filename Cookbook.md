...
### Only all the variables estimated from mean and standard deviation in the tidy set were included.

* mean(): Mean value
* std(): Standard deviation

### The data were averaged based on subject ID and activity group.
